...
namespace SecureApi.Migrations
{
    ...
    [Migration("20251121182303_AddApiKeys")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SecureApi.Infrastructure.Persistence.Models.ApiKey", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("SecureApi.Infrastructure.Persistence.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("SecureApi.Infrastructure.Persistence.Models.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("SecureApi.Infrastructure.Persistence.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("SecureApi.Infrastructure.Persistence.Models.RefreshToken", b =>
                {
                    b.HasOne("SecureApi.Infrastructure.Persistence.Models.User", "User")
                        .WithMany()
